...
plt.plot(losses[0], lw=2, label='serial, gamma=%f' % learning_rates[0])
plt.plot(losses[1], lw=2, label='parallel random, gamma=%f' % learning_rates[1])
plt.plot(losses[2], lw=2, label='parallel correlation, gamma=%f' % learning_rates[2])
plt.tight_layout()
