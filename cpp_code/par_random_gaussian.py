...
if __name__ == '__main__':
    ...
    cmd = ['./par_random_gaussian', str(args.numsamples), str(args.dimension), str(args.numthreads), str(args.learningrate), str(args.numiterations), str(args.printperiod), str(args.logperiod)]
    print(' '.join(cmd))
    call(cmd)
