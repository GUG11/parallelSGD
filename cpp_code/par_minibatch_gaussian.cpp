...
int main(int argc, char* argv[]) {
    ...
    writeSGDProfile("../results/simulations/Gaussian/minibatch", partMethod + "_n" + std::to_string(n) + "_d" + std::to_string(d) + "_B" + std::to_string(batchSize) + "_T" + std::to_string(numIters) + "_gamma" + std::to_string(learningRate), sgdProfile);
